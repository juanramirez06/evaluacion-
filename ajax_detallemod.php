...
$solohora = date("H:i:s");
 ...
 $sql = "SELECT id_detalle FROM detalles WHERE id_propiedad = '$id_propiedad ' AND  ip_detalle = '$ip' AND id_carac = '$id_carac'";
 ...
 if ($cancan == 0)
 {
			...
			$sql .= "                   VALUE ('$prox_id','$id_propiedad', '$id_carac', '$valor', '', '0', '$ip' )";
			echo $sql;
 ...
 {
	 $sql = "UPDATE detalles SET can_carac = '$valor' WHERE id_propiedad = '$id_propiedad' AND id_carac = '$id_carac' ";
